...
class JWT
{
    ...
    public static function decode($jwt, $keyOrKeyArray, array $allowed_algs = array())
    {
        ...
        // BeyondCart: Commented because it brokes the cart of users who are logged in for more than 30 days
        // TODO: check for expired token in the app and log out the user!
